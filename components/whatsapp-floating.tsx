...
export function WhatsAppFloating() {
  return (
    <div className="fixed bottom-5 right-5 z-50">
      <WhatsAppLink className="group flex items-center gap-3 rounded-full bg-[#25D366] px-4 py-3 text-sm font-semibold text-black shadow-soft">
        ...
        <span className="rounded-full bg-black/10 px-2 py-1 text-xs font-bold">online</span>
        <span className="ml-1 text-black/70 transition group-hover:translate-x-0.5">→</span>
      </WhatsAppLink>
    </div>
  );
}
